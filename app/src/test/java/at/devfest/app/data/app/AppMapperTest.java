...
public class AppMapperTest {
    ...
    private final Speaker speaker1 = new Speaker(10, "Gautier", null, null, null, null, null, null, null, null, null);
    private final Speaker speaker2 = new Speaker(20, "Mounir", null, null, null, null, null, null, null, null, null);
    private final Speaker speaker3 = new Speaker(30, "Thomas", null, null, null, null, null, null, null, null, null);
    private final Speaker speaker4 = new Speaker(40, "Arnaud", null, null, null, null, null, null, null, null, null);
    private final Speaker speaker5 = new Speaker(50, "Jérémie", null, null, null, null, null, null, null, null, null);
    ...
    public void should_convert_sessions_list_into_schedule() {
        ...
        Session session1 = new Session(1, "room1", singletonList(speaker1), "title1", "desc1", slot1, slot1.plusHours(1), null);
        Session session2 = new Session(2, "room2", singletonList(speaker2), "title2", "desc2", slot1, slot1.plusHours(1), null);
        Session session3 = new Session(3, "room1", singletonList(speaker3), "title3", "desc3", slot2, slot2.plusHours(1), null);
        Session session4 = new Session(4, "room1", singletonList(speaker4), "title4", "desc4", slot3, slot3.plusHours(1), null);
        Session session5 = new Session(5, "room1", singletonList(speaker5), "title5", "desc5", slot4, slot4.plusHours(1), null);
