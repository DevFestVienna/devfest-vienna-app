...
public class NetworkMapperTest {
    ...
    public void should_convert_network_speakers_to_app_speakers() {
        ...
        // When
        List<at.devfest.app.data.app.model.Speaker> result = networkMapper.toAppSpeakers(speakers);
    ...
    public void should_convert_network_sessions_to_app_sessions() {
        ...
        // When
        List<at.devfest.app.data.app.model.Session> result = networkMapper.toAppSessions(singletonList(session), speakersMap);
