...
public class DbMapperTest {
    ...
    public void should_convert_db_sessions_to_app_sessions() {
        ...
        at.devfest.app.data.database.model.Session session = new at.devfest.app.data.database.model.Session(2, "now", 10, 3, "[1]", "title", "description", null);
        List<at.devfest.app.data.database.model.Session> sessions = singletonList(session);
    ...
    public void should_convert_app_speaker_to_db_speaker() {
        ...
        // When
        at.devfest.app.data.database.model.Speaker result = dbMapper.fromAppSpeaker(speaker);
    ...
    public void should_convert_db_speakers_to_app_speakers() {
        // Given
        at.devfest.app.data.database.model.Speaker speaker = new at.devfest.app.data.database.model.Speaker(58, "nilh", "dev", "bio", "nilhcem.com", "Nilhcem", "nilhcem", "https://plus.google.com/+GautierMechling", "", "https://www.linkedin.com/in/gautier-mechling-9a0a7236", "photo");
